...
객체 구성 (객체가 가진 데이터를 객체 내에서 제어.)
(객체에 포함된 변수를 프로퍼티/속성 이라고 호칭)
객체 구성 (객체에 포함된 변수를 메소드/기능 이라고 호칭)
const obj = {
프로퍼티명 : 원시값 또는 다른 객체,
“프로퍼티명” :  string,
“프로퍼티명” : [],
...
인스턴스 란 ? 
: 남에게 말해주기가 어려운 개념
: 객체를 생성하는 방법을 활용해 생성한 변수를 인스턴스라고 한다. (핵심)
객체 리터럴 문법 : 활용빈도 높다.  
const 인스턴스 = {}
const 인스턴스 = {
    “myName” : 5,
